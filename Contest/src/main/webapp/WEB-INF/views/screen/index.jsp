...
<div class="container" style="margin:30px 400px" >
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:2020px; margin-left:-500px;">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="resources/images/recurit.JPG" alt="Generic placeholder image" width="140" height="140">
          
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="resources/images/team.jpg" alt="Generic placeholder image" width="240" height="200">
           
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="resources/images/eval.jpg" alt="Generic placeholder image" width="240" height="200">
